...
def register():
    ...
    if form.validate_on_submit():
        ...
        hash_salted_password = generate_password_hash(form.password.data, method='pbkdf2:sha256', salt_length=8)
        new_user = User(
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            flash("That email does not exist, please register and try again")
